...
use crate::web::common::constants::memory_manager::{
    BACKUP_DATA_MEMORY_ID, CANISTER_LIST_MEMORY_ID, EXCHANGE_RATE_MEMORY_ID, PREDICTION_MEMORY_ID,
    PREDICTOR_CONTEXT_MEMORY_ID, RECORD_MEMORY_ID, ROLE_USER_TREE_MEMORY_ID, STAKE_MEMORY_ID,
    STAKING_RECORD_MEMORY_ID, TEMP_MAP_MEMORY_ID, TEMP_VEC_MEMORY_ID, USER_CONTEXT_MEMORY_ID,
