...
use ic_cdk::api::management_canister::main::{
    CanisterId, CanisterIdRecord, CanisterInfoRequest, CanisterInfoResponse, CanisterSettings,
...
pub async fn deposit_cycles(
    ...
    call_with_payment128(user_principal, "deposit_cycles", (canister_id,), cycles).await
}
